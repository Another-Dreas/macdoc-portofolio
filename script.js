document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================
    const skillsData = [
        { icon: "fab fa-js", title: "JavaScript (ES6+)", desc: "Manipulasi DOM Dinamis & Logika Sistem", type: "wide" },
        { icon: "fab fa-html5", title: "HTML5", type: "square" },
        { icon: "fab fa-css3-alt", title: "CSS3", type: "square" },
        { icon: "fab fa-react", title: "Next.js", type: "square" },
        { icon: "fas fa-mobile-alt", title: "Capacitor", type: "square" },
        { icon: "fas fa-database", title: "SQLite & Relational DB", desc: "Penyimpanan Lokal & Optimasi Query", type: "wide" }
    ];

    const timelineData = [
        { date: "2026 - Saat Ini", title: "CTO & Lead Engineer", desc: "Memimpin visi teknis untuk platform berbasis AI terkemuka. Bertanggung jawab atas ketersediaan server tinggi." },
        { date: "2024 - 2026", title: "Senior Frontend Developer", desc: "Membangun antarmuka interaktif dan arsitektur micro-frontend enterprise global berskala jutaan pengguna." },
        { date: "2023 - 2024", title: "Junior Fullstack Developer", desc: "Mulai mendalami backend dengan Node.js. Menjadi finalis di berbagai Hackathon tingkat nasional." },
        { date: "2021 - 2023", title: "Intermediate UI/UX Designer", desc: "Berhasil merancang prototipe aplikasi dengan fokus pada pengalaman pengguna (UX) yang intuitif." }
    ];
    ...
    const renderQuote = () => {
        ...
        container.innerHTML = '';
        quoteWords.forEach(word => { container.innerHTML += `<span class="q-word">${word}</span> `; });
    };
                ...
                if (heroImgContainer) {
                    ...
                    setTimeout(() => {
                        ...
                        if(imgElement) {
                            ...
                            setTimeout(() => { imgElement.classList.remove('glitch-active'); }, 600); 
                        }
                    }, 1500); 
                }
            }, 300); 
    ...
    const closeOverlayAction = () => {
        ...
        if (editorialPhoto) setTimeout(() => { editorialPhoto.classList.remove('overlay-animate-in'); }, 400); 
    };
    ...
    if (btnOpenFullAbout && bottomSheetModal) {
        btnOpenFullAbout.addEventListener('click', (e) => {
            ...
            history.pushState({ overlayOpen: true }, null, "#about-detail");
        });
    }
    ...
    window.addEventListener('popstate', (e) => { if (bottomSheetModal && bottomSheetModal.classList.contains('active')) closeOverlayAction(); });
    ...
    if (bottomSheetModal) {
        ...
        }, { root: bottomSheetModal, threshold: 0.1, rootMargin: "0px 0px -20px 0px" });
    ...
    if (quoteSection && bottomSheetModal) {
        ...
        }, { root: bottomSheetModal, threshold: 0.5 });
